...
"""
Relative attention classes below are taken / modified from Pytorch, modified by Damon Gwinn
...
class AlignmentTransformer(nn.Module):
    ...
    def __init__(
        ...
        # self.embedding_score = nn.Embedding(128,128) # can I use the same embedding?
